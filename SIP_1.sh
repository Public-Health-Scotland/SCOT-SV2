...
for run in /data/encrypted/inbox/2*/
do
	...
	# run artic pipeline
	conda activate /data/tools/miniconda3/envs/nextflow_241129/
	/usr/bin/time -o $runname.stats.txt nextflow run /data/tools/ncov2019-artic-nf/  --illumina --directory $workingdir --prefix "$runname" -profile conda --cache /data/scratch/ --ref /data/tools/primer-schemes/nCoV-2019/V5.3.2/SARS-CoV-2.reference.fasta --bed /data/tools/primer-schemes/nCoV-2019/V5.3.2/SARS-CoV-2.primer.bed
