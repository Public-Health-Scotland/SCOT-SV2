...
do
	...
	/usr/bin/time -o $runname.stats.txt nextflow run /data/tools/ncov2019-artic-nf/  --illumina --directory $workingdir --prefix "$runname" -profile conda --cache /data/scratch/ --ref /data/tools/primer-schemes/nCoV-2019/V4/SARS-CoV-2.reference.fasta --bed /data/tools/primer-schemes/nCoV-2019/V4.1/SARS-CoV-2.primer.bed
