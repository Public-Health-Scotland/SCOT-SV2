...
do
	...
	/usr/bin/time -o $runname.stats.txt nextflow run /data/tools/ncov2019-artic-nf/  --illumina --directory $workingdir --prefix "$runname" -profile conda --cache /data/encrypted/scratch/ --ref /data/tools/primer-schemes/nCoV-2019/V3/nCoV-2019.reference.fasta --bed /data/tools/primer-schemes/nCoV-2019/V3/nCoV-2019.primer.bed
